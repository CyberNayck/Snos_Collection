...
banner = pyfiglet.figlet_format("SevaReport")
...
def complaint():
	print(color_banner)
	print("[1] Снос аккаунта // BY @SUBTEXT73")
	print("[2] Снос канала // BY @SUBTEXT73")
	print("[3] Снос бота // BY @SUBTEXT73")
	print()
	print()
	...
	if choice == '1':
		print("[1] Снос према // BY @SUBTEXT73")
		print("[2] Снос за вирт // BY @SUBTEXT73")
		print("[3] Снос сессии // BY @SUBTEXT73")
		print("[4] Снос за спам // BY @SUBTEXT73")
