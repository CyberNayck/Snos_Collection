...
banner = pyfiglet.figlet_format("SevaSnos")
	...
	try:
		for _ in range(int(repeats)):
			...
			if response.status_code == 200:
				complaints_sent += 1
				print("Жалоба отправлена с:", email, "",  number)
			else:
...
def complaint():
	...
	print(colored(f"LocalHost: {ip}", "green"))
	print(colored(f"Точное время запуска: {time}", "cyan"))
	print()
	print()
	print(colored("[1] снос за вирт", "cyan"))
	print(colored("[2] снос према","cyan"))
	print(colored("[3] снос за оск","cyan"))
	print(colored("[4] снос за нарушение правил", "cyan"))
	print(colored("[5] снос сессии", "cyan"))
	print(colored("[6] снос за спам", "cyan"))
	print(colored("[7] снос прайса", "cyan"))
	print(colored("[8] снос за накрутку", "cyan"))
	print()
	print()
	complaint_choice = input(colored(">>>", "cyan"))

	if complaint_choice in ["1", "2", "3", "4", "6", "7", "8"]:
		username = input("Введите юзернейм ( если это канал, юзер админа, нарушение ): ")
